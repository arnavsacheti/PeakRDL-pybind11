"""
Integration tests for is_flag and is_enum UDP properties
"""
...
# RDL content with is_flag and is_enum UDP properties
RDL_CONTENT = """
property is_flag {
    component = reg;
    type = boolean;
...
@pytest.fixture
def rdl_file(temp_output_dir: Path) -> Path:
...
def test_udp_detection(rdl_file: Path, temp_output_dir: Path) -> None:
...
def test_flag_and_enum_in_nodes(rdl_file: Path) -> None:
...
def test_normal_register_not_flagged(rdl_file: Path) -> None:
