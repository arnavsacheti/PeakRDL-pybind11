...
class TestRegisterIntFlag:
    ...
    def test_create_flag_class(self) -> None:
    ...
    def test_flag_bitwise_operations(self) -> None:
...
class TestRegisterIntEnum:
    ...
    def test_create_enum_class(self) -> None:
...
class TestFlagEnumIntegration:
    ...
    def test_flag_vs_enum_behavior(self) -> None:
