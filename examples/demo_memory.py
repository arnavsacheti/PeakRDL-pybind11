...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("2. Exporting to PyBind11 C++...")
        ...
        for mem in nodes["mems"]:
            ...
            entry_reg = next(iter(mem.children()))
        ...
        with open(os.path.join(output_dir, "demo_soc_descriptors.hpp")) as f:
            content = f.read()
        ...
        with open(os.path.join(output_dir, "demo_soc_bindings.cpp")) as f:
            content = f.read()
        ...
        with open(os.path.join(output_dir, "__init__.pyi")) as f:
            content = f.read()
